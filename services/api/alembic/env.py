...
# an empty metadata cheerfully produces a migration that drops everything.

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# The one place the connection string is set. `alembic.ini` leaves it blank so that a
# committed file can never point a migration at the wrong database.
