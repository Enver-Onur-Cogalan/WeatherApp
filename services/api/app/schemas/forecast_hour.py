...
class ForecastHour(BaseModel):
    ...
    local_hour: int = Field(ge=0, le=23, description="Hour of day in the location's timezone. Denormalised because every query needs it.")
    temperature_c: float
    ...
    weather_code: int = Field(description="WMO code. The source of truth for which atmosphere state renders — precipitation and cloud cover alone cannot tell snow from rain.")
